...
updated: "2026-08-13T19:02:40+09:00"
status: superseded-for-go
---
...
2026-08-13 にユーザーは現行GoのAT-10aについて **A-0** を選択した。対象日の入力に1ファイルの1行でも不正があれば全体を疑わしいものとして転記せず、通知でその旨を警告する。

以下のA-1、I-before、I-afterの比較と実装設計は、採用しなかった案および過去の検討履歴であり、現行Goの契約ではない。現行Goの決定正本は `docs/decisions/2026-08-13T190240_Go版AT-10a入力異常ポリシーをA-0へ確定.md` である。
